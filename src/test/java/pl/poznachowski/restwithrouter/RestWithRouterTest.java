package pl.poznachowski.restwithrouter;
...
public class RestWithRouterTest extends FunctionalMunitSuite {

	private static final String SOME_PAYLOAD = "Payload";
	private static final String REST_WITH_ROUTER_FLOW = "RestWithRouterFlow";
